...
import 'package:fitness/pages/on_board/veg_nonveg_info_page.dart';
import 'package:fitness/utils/app_colors.dart';
import 'package:fitness/utils/strings_style.dart';

class HealthIssueInfoPage extends StatefulWidget {
  const HealthIssueInfoPage({Key? key}) : super(key: key);

  @override
  _HealthIssueInfoPageState createState() => _HealthIssueInfoPageState();
}

class _HealthIssueInfoPageState extends State<HealthIssueInfoPage> {
  // var _onTap = 0;
  @override
